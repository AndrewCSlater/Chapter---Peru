...
# pca_occ = pca_ref2$x
# write.csv(pca_occ, "/storage/hpc/44/slatera6/SpLF3_DetOcc_PCA2_12reps_buffer500m_PCA_Components.csv", row.names = T)
# 
# 
# 
# #####
# ##### - PUT ALL VARIABLES IN A LIST - #####
# data = list(y = y.new, occ.covs = pca_occ[,1:2], det.covs = det.covs, coords = XY)
# # str(data)
# # is.na(det.covs)
...
#                            n.chains = 1)
# 
# filename = paste0("/storage/hpc/44/slatera6/SpLF3_DetOcc_PCA2_12reps_buffer500m_MODEL.Rdata")
...
# filename = paste0("/storage/hpc/44/slatera6/SpLF3_DetOcc_PCA2_12reps_buffer500m_FITTED_SAMPLES.Rdata")
...
# write.csv(auc.vals, "/storage/hpc/44/slatera6/SpLF3_DetOcc_PCA2_12reps_buffer500m_AUC.csv", row.names = F)

load("/storage/hpc/44/slatera6/SpLF3_DetOcc_PCA2_12reps_buffer500m_MODEL.Rdata")
ppc = ppcOcc(out.sfMsPGOcc, fit.stat = 'freeman-tukey', group = 1) # Group 1 = By Station
save(ppc, file = "/storage/hpc/44/slatera6/SpLF3_DetOcc_PCA2_12reps_buffer500m_Bayesian_P.Rdata")
