...
# ################################################
# gc()
y.rep.samples.NewFitting <- fittedNew(out.sfMsPGOcc)$y.rep.samples
filename = paste0("/storage/hpc/44/slatera6/SpLF3_DetOcc_PCA1_12reps_buffer500m_FITTED_SAMPLES_NewStyle.Rdata")
...
write.csv(auc.vals, "/storage/hpc/44/slatera6/SpLF3_DetOcc_PCA1_12reps_buffer500m_AUC_NewStyleFit.csv", row.names = F)
