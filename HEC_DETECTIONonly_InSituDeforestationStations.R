...
rem = c()
for (i in 1:nrow(ssPnt.14)) { # For each species
  # i = 100
  df = ssPnt.14[i,,]
  site = df
...
filename = paste0("/storage/hpc/44/slatera6/DETECTION_ONLY_50k10k1k2ch",reps[j],".Rdata")
save(out.det, file = filename)
}